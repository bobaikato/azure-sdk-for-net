...
This sample demonstrates how to manually create a routine job and to use custom trigger. In this scenario, a single run is dispatched using teams message and one using manual dispatch.
